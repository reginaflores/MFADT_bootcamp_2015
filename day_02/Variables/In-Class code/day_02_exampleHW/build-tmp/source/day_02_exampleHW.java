...
public class day_02_exampleHW extends PApplet {
...
public void draw() {
  float mySizeX = map(mouseX, 0, width, 30, 50);
  float mySizeY = map(mouseY, 0, height, 30, 50);
  mMovementX += 5;
  mAngle -= 2;
  mSize -=1;
  mHue += 1;
...
//  rect(mMovementX+200, 200, mSize, mSize);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "day_02_exampleHW" };
    if (passedArgs != null) {
