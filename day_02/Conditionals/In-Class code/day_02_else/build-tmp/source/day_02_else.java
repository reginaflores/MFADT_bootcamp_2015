...
public class day_02_else extends PApplet {

//----------------------------------------------------
// DT Bootcamp 2015, Parsons the New School for Design. 
// Day 2, Example 5, Theme: If/else
// Basic use of an if and else statement is shown here.
...
public void draw() {
  ...
  else { //If the previous statement is not true (if the mouse is less than width/2), do the following:
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "day_02_else" };
    if (passedArgs != null) {
